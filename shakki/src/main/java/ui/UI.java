...
public class UI extends javax.swing.JFrame {
    ...
    private void initComponents(Game peli) {
        ...
        historiaKentta = new javax.swing.JTextArea();
...
//        getContentPane().setLayout(lautaLayout);
        ...
        lautaLayout.setVerticalGroup(
                lautaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(lautaLayout.createSequentialGroup()
                        .addGroup(lautaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(a8, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(100)
                                .addComponent(b8, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(100)
    ...
    public void updateUI() {
        historiaKentta.setText(peli.getTurnHistory().toString());
        a1label.setText(Character.toString(peli.getLauta().getNappula("a1").getMerkki()));
        a2label.setText(Character.toString(peli.getLauta().getNappula("a2").getMerkki()));
        a3label.setText(Character.toString(peli.getLauta().getNappula("a3").getMerkki()));
        a4label.setText(Character.toString(peli.getLauta().getNappula("a4").getMerkki()));
        a5label.setText(Character.toString(peli.getLauta().getNappula("a5").getMerkki()));
        a6label.setText(Character.toString(peli.getLauta().getNappula("a6").getMerkki()));
        a7label.setText(Character.toString(peli.getLauta().getNappula("a7").getMerkki()));
        a8label.setText(Character.toString(peli.getLauta().getNappula("a8").getMerkki()));

        b1label.setText(Character.toString(peli.getLauta().getNappula("b1").getMerkki()));
        b2label.setText(Character.toString(peli.getLauta().getNappula("b2").getMerkki()));
        b3label.setText(Character.toString(peli.getLauta().getNappula("b3").getMerkki()));
        b4label.setText(Character.toString(peli.getLauta().getNappula("b4").getMerkki()));
        b5label.setText(Character.toString(peli.getLauta().getNappula("b5").getMerkki()));
        b6label.setText(Character.toString(peli.getLauta().getNappula("b6").getMerkki()));
        b7label.setText(Character.toString(peli.getLauta().getNappula("b7").getMerkki()));
        b8label.setText(Character.toString(peli.getLauta().getNappula("b8").getMerkki()));

        c1label.setText(Character.toString(peli.getLauta().getNappula("c1").getMerkki()));
        c2label.setText(Character.toString(peli.getLauta().getNappula("c2").getMerkki()));
        c3label.setText(Character.toString(peli.getLauta().getNappula("c3").getMerkki()));
        c4label.setText(Character.toString(peli.getLauta().getNappula("c4").getMerkki()));
        c5label.setText(Character.toString(peli.getLauta().getNappula("c5").getMerkki()));
        c6label.setText(Character.toString(peli.getLauta().getNappula("c6").getMerkki()));
        c7label.setText(Character.toString(peli.getLauta().getNappula("c7").getMerkki()));
        c8label.setText(Character.toString(peli.getLauta().getNappula("c8").getMerkki()));

        d1label.setText(Character.toString(peli.getLauta().getNappula("d1").getMerkki()));
        d2label.setText(Character.toString(peli.getLauta().getNappula("d2").getMerkki()));
        d3label.setText(Character.toString(peli.getLauta().getNappula("d3").getMerkki()));
        d4label.setText(Character.toString(peli.getLauta().getNappula("d4").getMerkki()));
        d5label.setText(Character.toString(peli.getLauta().getNappula("d5").getMerkki()));
        d6label.setText(Character.toString(peli.getLauta().getNappula("d6").getMerkki()));
        d7label.setText(Character.toString(peli.getLauta().getNappula("d7").getMerkki()));
        d8label.setText(Character.toString(peli.getLauta().getNappula("d8").getMerkki()));

        e1label.setText(Character.toString(peli.getLauta().getNappula("e1").getMerkki()));
        e2label.setText(Character.toString(peli.getLauta().getNappula("e2").getMerkki()));
        e3label.setText(Character.toString(peli.getLauta().getNappula("e3").getMerkki()));
        e4label.setText(Character.toString(peli.getLauta().getNappula("e4").getMerkki()));
        e5label.setText(Character.toString(peli.getLauta().getNappula("e5").getMerkki()));
        e6label.setText(Character.toString(peli.getLauta().getNappula("e6").getMerkki()));
        e7label.setText(Character.toString(peli.getLauta().getNappula("e7").getMerkki()));
        e8label.setText(Character.toString(peli.getLauta().getNappula("e8").getMerkki()));

        f1label.setText(Character.toString(peli.getLauta().getNappula("f1").getMerkki()));
        f2label.setText(Character.toString(peli.getLauta().getNappula("f2").getMerkki()));
        f3label.setText(Character.toString(peli.getLauta().getNappula("f3").getMerkki()));
        f4label.setText(Character.toString(peli.getLauta().getNappula("f4").getMerkki()));
        f5label.setText(Character.toString(peli.getLauta().getNappula("f5").getMerkki()));
        f6label.setText(Character.toString(peli.getLauta().getNappula("f6").getMerkki()));
        f7label.setText(Character.toString(peli.getLauta().getNappula("f7").getMerkki()));
        f8label.setText(Character.toString(peli.getLauta().getNappula("f8").getMerkki()));

        g1label.setText(Character.toString(peli.getLauta().getNappula("g1").getMerkki()));
        g2label.setText(Character.toString(peli.getLauta().getNappula("g2").getMerkki()));
        g3label.setText(Character.toString(peli.getLauta().getNappula("g3").getMerkki()));
        g4label.setText(Character.toString(peli.getLauta().getNappula("g4").getMerkki()));
        g5label.setText(Character.toString(peli.getLauta().getNappula("g5").getMerkki()));
        g6label.setText(Character.toString(peli.getLauta().getNappula("g6").getMerkki()));
        g7label.setText(Character.toString(peli.getLauta().getNappula("g7").getMerkki()));
        g8label.setText(Character.toString(peli.getLauta().getNappula("g8").getMerkki()));

        h1label.setText(Character.toString(peli.getLauta().getNappula("h1").getMerkki()));
        h2label.setText(Character.toString(peli.getLauta().getNappula("h2").getMerkki()));
        h3label.setText(Character.toString(peli.getLauta().getNappula("h3").getMerkki()));
        h4label.setText(Character.toString(peli.getLauta().getNappula("h4").getMerkki()));
        h5label.setText(Character.toString(peli.getLauta().getNappula("h5").getMerkki()));
        h6label.setText(Character.toString(peli.getLauta().getNappula("h6").getMerkki()));
        h7label.setText(Character.toString(peli.getLauta().getNappula("h7").getMerkki()));
